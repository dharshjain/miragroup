                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="Water Solutions">01. Water Solutions (Raw, RO, DM, Bulk Water Supply)</SelectItem>
                        <SelectItem value="Chemical & Specialized Tankers">02. Chemical & Specialized Tankers (ACN, SS, ISO)</SelectItem>
                        <SelectItem value="Heavy Vehicles & Equipment">03. Heavy Vehicles & Equipment (Excavators & Earthmoving)</SelectItem>
